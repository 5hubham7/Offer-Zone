...
const CustomerLoginPhone = (navigation) => {
    ...
    const sendOTP = async () => {
        if (CustomerDetails.phoneNo.length !== 10) {
            stopLoading();
            ...
            try {
                ...
                navigation.data.navigate("CustomerOTPVerification", {
                    CustomerData,
                    Id,
                    method,
                });
    ...
    const onSendOTPPress = () => {
        ...
        try {
            axios
                .get(
                    `${axiosURL}/customer/getCustomerDataViaPhone/+91${CustomerDetails.phoneNo}`
                )
                .then((response) => {
                    if (
...
export default CustomerLoginPhone;
