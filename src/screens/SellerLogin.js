...
import SellerLoginEmail from "../components/SellerLoginEmail";
import SellerLoginPhone from "../components/SellerLoginPhone";
...
const SellerLogin = ({ navigation }) => {
    ...
    return (
        <SellerLoginContext.Provider value={authContext}>
            ...
            <View style={styles.container}>
                ...
                >
                    {State.isEmailLogin ? (
                        <SellerLoginEmail data={navigation} />
                    ) : State.isPhoneLogin ? (
                        <SellerLoginPhone data={navigation} />
                    ) : (
