...
import CustomerOTPInputBox from "../components/OTPInputBox";
...
const CustomerOTPVerification = ({ navigation, route }) => {
    ...
    // useEffect(() => {
    //     console.log("CustomerOTPVerification", route)
    // }, [])
    ...
    const onResendOtpButtonPress = async () => {
        ...
        try {
            ...
            const verificationId = await phoneProvider.verifyPhoneNumber(
                route.params.CustomerData.phone,
                    ...
                    await firebase
                        ...
                        .then((response) => {
                            ...
                            if (data) {
                                ...
                                signUp(customerData.id, customerData.name);
                            }
                        })
                        .catch((err) => {
                            stopLoading();
    ...
    const getCustomerDataViaPhone = (phone) => {
        //console.log(phone)
        axios
            ...
            <View style={styles.container}>
                ...
                >
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        {AutoOTPEnter ? (
                            <CustomerOTPInputBox data={"otp"} />
                        ) : (
                            <CustomerOTPInputBox data={[]} />
                        )}
                        <View>
                            <TouchableOpacity
